...
<div class="container-fluid">
    ...
    <div class="row">
        <div class="col-lg-6">
            <div class="my-3">
                <h5>Setoran Nasabah</h5>
            </div>

            <form action="<?= base_url('apps/setoran') ?>" method="post" class="form-horizontal mt-5">
                ...
                <div class="box-body">
                    <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                            <div class="input-group">
                                <input type="text" class="form-control" id="id_nasabah" name="id_nasabah" placeholder="Nomor Rekening Nasabah" readonly>
                                <span class="input-group-btn">
                                    <button type="button" class="btn btn-success" data-toggle="modal" data-target="#modal">Browse</button>
                                </span>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                            <input type="hidden" id="penarikan" name="penarikan" class="form-control" value="0" readonly>
                            <input name="setoran" type="text" class="form-control" placeholder="Masukkan Jumlah" onkeyup="convertToRupiah(this);">
                            <?= form_error('setoran', '<small class="text-danger">', '</small>'); ?>
                        </div>
                    </div>
                </div>
...
<div class="modal fade bd-example-modal-lg" id="modal" tabindex="-1" role="dialog" aria-labelledby="setoranModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            <form id="" method="post" action="<?= base_url('apps/setoran') ?>">
